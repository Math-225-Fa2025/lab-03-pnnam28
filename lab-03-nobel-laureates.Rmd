...
1.  How many observations and how many variables are in the dataset? Use inline code to answer this question. What does each row represent?  
    ...
    ANSWER: There are 935 observations and there are 26 variables in the dataset. 
...
3.  Create a faceted bar plot visualizing the relationship between the category of prize and whether the laureate was in the US when they won the nobel prize.
    ...
    ANSWER: Based on the plot we can say that the Buzzfeed was true. Most of the Laureate was from USA.
    
```{r plot_catagories_vs_US,message=TRUE, eval=TRUE, echo=TRUE}
nobel_living_science %>% 
  ...
  labs(
    ...
    subtitle = "Comparing US vs Other countries",
    x= "Country",
    y = "Count",
  )+
  theme_minimal()+
...
```{r create_born_in_US, eval=TRUE, echo=TRUE}
...
5.  Add a second variable to your visualization from Exercise 3 based on whether the laureate was born in the US or not.
    ...
    ANSWER: Overall, there are about 2/3 of the laureate was born outside of the US in Chemistry, Medicine and Physics catagories. On the other side, we can say that most of the eventhough the USA has the most Nobel laureate in Economics but there were about 1/6 of the laureate was born outside of the US.There are a small number of laureate was born in the US but got the nobel prize for Other countries in Medicine and Physic catagorized.

```{r plot_born_in_us, eval=TRUE, echo=TRUE}
nobel_living_science %>% 
...
```{r Nobel_prize_outsideUS, eval=TRUE, echo=TRUE}
nobel_living_science %>%
